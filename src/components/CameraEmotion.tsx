...
export default function CameraEmotion({ apiUrl = import.meta.env.VITE_EMOTION_API_URL || 'http://localhost:8000', intervalMs = 4000, onResult, onHealthChange, className }: Props){
